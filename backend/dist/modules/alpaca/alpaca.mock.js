...
exports.alpacaMock = {
    async createAccount(_kyc) {
        return { accountId: `mock-${(0, uuid_1.v4)()}` };
    },
    async fundAccount(_accountId, _amount) {
        return;
    },
    async buyETF(_accountId, _symbol, _amount) {
        return { orderId: `order-${(0, uuid_1.v4)()}` };
    },
