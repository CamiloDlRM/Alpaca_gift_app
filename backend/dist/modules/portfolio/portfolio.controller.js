...
exports.getPriceHistoryHandler = getPriceHistoryHandler;
const portfolioService = __importStar(require("./portfolio.service"));
...
async function getPriceHistoryHandler(req, res, next) {
    try {
