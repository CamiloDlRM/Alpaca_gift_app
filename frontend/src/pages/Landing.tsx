          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative hidden lg:block">
              <div className="bg-gray-50 dark:bg-gray-800 rounded-3xl p-8 border border-gray-100 dark:border-gray-700">
                <div className="text-sm text-gray-500 dark:text-gray-400 mb-2">Portfolio Growth</div>
                <div className="text-3xl font-bold text-gray-900 dark:text-white mb-1">$1,247.83</div>
                <div className="text-sm text-green-500 font-medium mb-6">+12.48% all time</div>
              ...
              <div className="absolute -top-4 -right-4 bg-white dark:bg-gray-700 rounded-xl shadow-lg p-4 border border-gray-100 dark:border-gray-600">
                <div className="text-xs text-gray-500 dark:text-gray-400">VOO</div>
                <div className="text-sm font-bold text-gray-900 dark:text-white">$445.23</div>
                <div className="text-xs text-green-500">+1.2%</div>
              </div>
              <div className="absolute -bottom-4 -left-4 bg-white dark:bg-gray-700 rounded-xl shadow-lg p-4 border border-gray-100 dark:border-gray-600">
                <div className="text-xs text-gray-500 dark:text-gray-400">Gift Sent</div>
                <div className="text-sm font-bold text-gray-900 dark:text-white">$500.00</div>
          ...
          <div className="grid sm:grid-cols-3 gap-8">
            {[
              ...
              <div key={item.step} className="text-center">
                <div className="w-14 h-14 rounded-full bg-[#F5C518] text-black font-bold text-lg flex items-center justify-center mx-auto mb-6">
                  {item.step}
                </div>
      ...
      <section className="py-16 sm:py-24 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {testimonials.map((t) => (
              <div key={t.name} className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl p-8 shadow-sm">
